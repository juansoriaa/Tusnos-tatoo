...
const code = fs.readFileSync('src/components/ArtistProfile.tsx', 'utf8');
...
let newCode = code.replace('export default function Profile() {', constants);
fs.writeFileSync('src/components/ArtistProfile.tsx', newCode);
