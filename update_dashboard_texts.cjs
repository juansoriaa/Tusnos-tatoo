...
// Update WhatsApp JSX
const oldWhatsapp = `<div className="flex items-center gap-3 bg-surface-container-low p-3 border border-outline-variant/10">
                                        <span className="material-symbols-outlined text-primary text-sm" data-icon="chat" style={{color: '#054d44'}}>chat</span>
                                        <input className="w-full bg-transparent border-none p-0 focus:ring-0 text-xs outline-none" placeholder="WhatsApp (Ej: +54 9 11...)" type="text" value={whatsapp} onChange={(e) => setWhatsapp(e.target.value)} />
                                    </div>`;

const newWhatsapp = `<div className="flex items-center gap-3 bg-surface-container-low p-3 border border-outline-variant/10 relative">
                                        ...
                                        <input className="w-full bg-transparent border-none p-0 focus:ring-0 text-xs outline-none" placeholder="11 1234 5678" type="text" value={whatsapp} onChange={(e) => setWhatsapp(e.target.value.replace(/[^0-9\s-]/g, ''))} />
