...
const targetBtn = `<button className="w-full max-w-md bg-primary text-on-primary py-3 px-6 font-label-md text-label-md font-extrabold uppercase tracking-widest shadow-2xl hover:bg-[#065f46] transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-4 shimmer-btn relative overflow-hidden">
...
if (profile.includes('Quiero un turno')) {
    profile = profile.replace(targetBtn, newBtn);
