...
const startMarker = '<div className="grid grid-cols-1 md:grid-cols-4 gap-4">';
const endMarker = '            </div>\n          </section>\n          </div>';
    ...
    const newGrid = `<div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="col-span-1 glass-panel border border-outline-variant/20 rounded-xl p-4 flex flex-col justify-between group hover:bg-surface-container-low transition-colors duration-200">
                <div className="flex justify-between items-start mb-4">
                  <span className="font-caption text-[10px] text-secondary uppercase tracking-widest leading-tight">Totales</span>
...
`;
    ...
    console.log('Successfully updated Zone 1 grid!');
} else {
