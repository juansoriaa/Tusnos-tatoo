            ...
            {uploadState === 'preview' && previewUrl && (
                <div className="space-y-4">
                    <div className="w-full h-48 border border-border-muted rounded-lg overflow-hidden relative group bg-deep-black" style={{borderColor: '#353434', backgroundColor: '#050505'}}>
                        ...
                        <div className="absolute bottom-3 right-3 flex items-center justify-center pointer-events-none z-10 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <button 
                                type="button"
