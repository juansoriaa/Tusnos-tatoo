  ...
  useEffect(() => {
    ...
    const fetchConfig = async () => {
      try {
        ...
        if (configDoc.exists()) {
          const dbData = configDoc.data();
          const dbImages = dbData.landingImages || {};
          ...
          setGlobalConfig((prev: any) => ({
            ...
            ...dbData,
            landingImages: {
              waitlist: cleanUrl(dbImages.waitlist, prev.landingImages.waitlist),
              metrics: cleanUrl(dbImages.metrics, prev.landingImages.metrics),
              design: cleanUrl(dbImages.design, prev.landingImages.design)
            }
          }));
        }
      } catch (error) {
...
</div>          {/* Zone 2: Supervisión de Rendimiento */}
